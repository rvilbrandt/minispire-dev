...
gestartet werden. Das Spiel benötigt keine Terminaleingaben oder Konsolenausgaben.
...
- Rastplätze, Ereignisse, Belohnungen und Kartenverbesserungen werden über Schaltflächen gewählt.
- Der Spielerzug kann über `Zug beenden` abgeschlossen werden.
